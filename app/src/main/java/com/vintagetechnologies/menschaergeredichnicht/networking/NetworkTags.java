...
public class NetworkTags {
	...
	/**
	 * Sender: Used to indicate that the host should send his up to date ActualGame class to the clients.
	 * Receiver: The message data contains/is an up to date ActualGame class.
	 */
